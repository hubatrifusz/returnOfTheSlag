...
<body>
    ...
    <form action="<?php echo e(route('slag.store')); ?>" method="POST" class="m-3">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\hubat\Desktop\Projects\ReturnOfTheSlag\resources\views/slag/create.blade.php ENDPATH**/ ?>